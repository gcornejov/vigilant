...
class BancoChileScraper(Scraper):
    ...
    def _login(self) -> None:
        ...
        self.page.locator(f"#{Locators.USER_INPUT_ID}").fill(Secrets.USERNAME)
        self.page.locator(f"#{Locators.PASSWORD_INPUT_ID}").fill(Secrets.PASSWORD)
        self.page.locator(f"#{Locators.LOGIN_BTN_ID}").click()
    ...
    def _get_current_amount(self) -> None:
        ...
        with suppress(TimeoutError):
            self.page.locator(f".{Locators.PROMOTION_BANNER_CLASS}").wait_for(
